...
/**
 * @brief Generates an E number fitting the restrictions.
 * 
 * @param e Result stored here.
 * @param phi Phi generated by RSA algorithm.
 * @param rstate Random state generator.
 */
...
/**
 * @brief Encrypt a message with RSA algorithm
 * 
 * @param e E parameter from RSA
 * @param n N parameter from RSA
 * @param plain plaintex message to encrypt
 */
...
/**
 * @brief Dencrypt a message with RSA algorithm
 * 
 * @param d D parameter from RSA
 * @param n N parameter from RSA
 * @param crypt Encrypted message for decryption.
 */
...
/**
 * @brief Will find two prime factor for num.
 * 
 * @param p Result number 1
 * @param q Result number 2
...
/**
 * @brief Tries to break a weak RSA encryption.
 * 
 * @param e RSA parameter passed from command line.
 * @param n RSA parameter passed from command line.
